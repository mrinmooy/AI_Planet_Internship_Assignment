...
./assignment
```
Your program should compile successfully and start executing. It will prompt for user input on the terminal, enter your desired input and you shall receive the output accordingly on the terminal itself.  
